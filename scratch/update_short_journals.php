...
$realisticJournals = [
    "Hari ini benar-benar melelahkan. Tugas pemrograman dari dosen sepertinya tidak ada habisnya. Saya sudah menghabiskan waktu berjam-jam untuk men-debug kode tapi masih saja ada error yang tidak masuk akal. Terkadang saya merasa ragu apakah ini jalur yang tepat, tapi kalau dipikir-pikir lagi, saya sudah sejauh ini. Mungkin saya hanya butuh istirahat sejenak. Semoga besok otak saya lebih segar untuk melanjutkannya.",
...
foreach ($journals as $journal) {
    // Ganti yang kependekan (kurang dari 100 karakter) ATAU yang ada kata 'dummy'
    if (strlen($journal->description) < 100 || stripos($journal->description, 'dummy') !== false) {
...
echo "Berhasil mengganti $count teks jurnal yang kependekan atau berisi dummy dengan catatan jurnal realistis yang lebih panjang.\n";
